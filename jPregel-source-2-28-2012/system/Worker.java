...
//        out.println("Worker.addVertexToWorker: vertexFactory.class: "  + vertexFactory.getClass().getName());
    ...
    public void startComputation( ComputeInput computeInput )
    {
...
//        out.println("Worker.barrierComputation: " + myWorkerNum + " starting step " + superStep );
        
        for ( int i = 0; i < computeThreads.length; i++ )
        {
            computeThreads[ i ].workIsAvailable( computeInput ); // notify ComputeThread
        }
...
//        out.println("Worker.barrierComputation: " + myWorkerNum + " all compute threads complete for step " + superStep );
...
//        out.println("Worker " + myWorkerNum + " numUnacknowledgedSendVertexIdToMessageQMaps: " 
//                + numUnacknowledgedSendVertexIdToMessageQMaps.intValue()
//                + " to add: " + numWorkersSentMessages);
...
//        out.println("Worker.barrierComputation: " + myWorkerNum + " all messages ack'd for step " + superStep );
    }
